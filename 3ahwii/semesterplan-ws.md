# Semesterplan 3HWII — Wintersemester 2026/27 (Klassenfassung 3AHWII)

> **Konkretisierung der Klasse 3ahwii.** Gerüst/Vorlage:
> [`../unterricht/HWII-SWP/jg3-semesterplan-ws.md`](../unterricht/HWII-SWP/jg3-semesterplan-ws.md).
> Das Gerüst bleibt klassen- und jahrgangsübergreifend unverändert; klassenspezifische
...
- Verteilung seiner 2 h (parallel/geblockt): **TBD**, siehe `../lehrplan/swp-hwii/3HWII/README.md` → Offene Punkte.
