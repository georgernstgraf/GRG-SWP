...
- [x] RIS-Recherche: Anlage 1.24 = BGBl. II Nr. 262/2015 idF 235/2019, aktuell → `lehrplan/RIS.md`
- [x] Offizieller SWP-Extrakt aus RIS-Dump `NOR40217058` verifiziert
- [x] `lehrplan/kompetenzmodule/README.md` (Matrix) + km3–km9 Steckbriefe (km5/km6 voll)
- [x] `lehrplan/3HWII/README.md` (Rahmen + INFI-Verbund komplett) + `semesterplan-ws.md` + `semesterplan-ss.md`
...
- [x] Klassenextrakt `lehrplan/3HWII/3HWII.lehrplan.md` erzeugt (Jg III, KM5+KM6, Schicht ①)
...
- [ ] PM-Koordination mit PRE-Kollegen klären (menschlich, vor SS-Start; TBD in `lehrplan/3HWII/README.md`)
...
2. Wenn 3HWII-Detailmaterial ansteht: UE-Ordner zu `lehrplan/3HWII/semesterplan-ws.md`
