...
## Current Focus
Klassen-Hub **`3ahwii/`** für SJ 2026/27 etabliert (Issue **#8**): Hub-README + Log,
Klassen-Semesterplan (`semesterplan-ws.md`) und die Sondereinheit **„Agentic Coding –
Einstieg"** (`2026-09-15_agentic-coding-einstieg/`). `unterricht/HWII-SWP/` bleibt
generisches Gerüst (ADR 2026-09-14).

## Completed (this cycle)
- [x] Klasse 3ahwii: Hub `3ahwii/README.md` + Log (Eintrag 2026-09-08 aus ARCHIV-Log herübergezogen)
- [x] Sondereinheit `3ahwii/2026-09-15_agentic-coding-einstieg/README.md` (Node/opencode-Setup via winget, freie Provider, Agent-Loop)
...
## Pending
- [ ] Sondereinheit am 2026-09-15 halten; HÜ-Eingang (opencode-Setup, `AGENTS.md`) prüfen
